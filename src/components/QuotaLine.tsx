// The 4px quota bar inside an account row. Presentational: features/quotas decides what it shows.
  ...
  return (
    <div className={styles["row"]} role="img" aria-label={description}>
      ...
      <div className={cx(styles["track"], !hasReading && styles["trackUnread"])} aria-hidden="true">
        {/* No reading means no fill: a zero-width fill would be indistinguishable from 0%. */}
        {hasReading && (
          <div
